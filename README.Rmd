...
that environment. These paths can be altered for the function to work outside of
the Aurora environemnt, but the lter-som group **SHOULD NOT** do this as we need to
document all changes, and a log file must exist.

**running the key file update to version 2 function, example:**

```{r key_update_v2, eval=FALSE}
