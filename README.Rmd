...
aggregated into a project Google Drive. Though all related to soils, these data
vary vastly in their structure, units of measure, granularity and other details.
To facilitate their use in models, the data must be homogenized to a sufficient
...
Install the current version from GitHub (after installing the `devtools` package
from CRAN):
...
**The QC functionality has been incorporated into the homogenization process. As
